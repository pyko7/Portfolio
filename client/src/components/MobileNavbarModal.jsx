                    ...
                    >
                        <Dialog.Panel className='w-full h-full' >
                            ...
                            <div className='w-full mb-16 flex justify-end'>
                                <FontAwesomeIcon icon={faXmark} tabIndex="0" className='w-9 h-9 text-secondary focus:outline-items focus:p-0' aria-label="Close navigation modal" onClick={() => setIsOpen(false)} />
                            </div>
