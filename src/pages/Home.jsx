...
const Home = () => {
    return (
        <section id='home' className='w-full max-w-[1920px] min-h-screen my-0 mx-auto flex justify-center items-center text-secondary md:items-start'>
            <div className='w-10/12 h-fit flex flex-col gap-y-9 animate-slidein xl:ml-14 sm:mx-0 md:mt-40 sm:px-4'>
                ...
                <div className='max-w-lg text-2xl text-justify sm:text-lg'>
