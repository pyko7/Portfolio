...
const About = () => {
  return (
    <section
      id="about"
      className="w-full min-h-screen flex flex-col justify-center items-center gap-y-16 text-secondary"
    >
      ...
      <div className="w-full flex items-start gap-x-24 lg:px-14 lg:gap-x-10 md:max-w-xl md:flex-col-reverse md:px-6 md:gap-y-8 sm:max-w-xl sm:px-10 sm:items-center sm:gap-y-10">
        ...
        <div className="w-1/2 text-2xl text-justify xl:text-xl lg:w-2/3 md:w-full md:h-auto sm:text-xl">
          <div className="w-8/12 flex flex-col gap-y-10 lg:w-full md:leading-snug sm:gap-y-7">
            <p>
              Hey there, my name is Julien Henry. I live in France, more
              precisely in Burgundy. I’ve always been interested in computing
              and technology. One of my other passions is sport. After acquiring
              a bachelor's degree to be a physical education professor, I’ve
              realized that sport was just a hobby but not my future job.
            </p>
            <p>
              After months of solo learning, I’ve decided to take the web
              developer training course at OpenClassrooms. Following this, I’m
              currently looking for my first experience as a front end
              developer.
            </p>
