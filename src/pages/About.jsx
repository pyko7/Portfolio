...
const About = () => {
    return (
        <section id='about' className='w-full max-w-[1920px] min-h-screen my-0 mx-auto flex flex-col justify-center items-center gap-y-16 text-secondary md:gap-y-8'>

            <h2 className='text-4xl font-bold uppercase md:my-12'>About me</h2>
            ...
            <div className='w-full flex items-start gap-x-24 lg:gap-x-14 md:max-w-xl md:flex-col-reverse md:px-6 md:gap-y-8 sm:max-w-lg  sm:items-center'>
                ...
                {/* text container */}
                <div className='w-1/2 text-2xl text-justify md:w-full md:h-auto sm:text-base'>
